...
Networks.livenet = Networks.add(require('@mangacoin-explore/coininfo')('MANGA').toBitcore());
...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for mangacoind is necessary for this upgrade with the "reindex=1" mangacoin.conf option. \n' +
                 'There are changes necessary in both mangacoin.conf and bitcore-node.json. \n\n' +
                 'To upgrade please see the details below and documentation at: \n' +
                 'https://github.com/monaco-ex/bitcore-node/blob/mangacoind/docs/upgrade.md \n');
